...
class Release(TypedDict):
    """GitHub release fields used by this script."""
...
def semver_key_sort(value: Release) -> Version:
    """sorting function"""
    parsed = Version.parse(value["tag_name"])
    return parsed
...
def cli(debug: bool = False) -> None:
    ...
    try:
        ...
        sys.exit()
    data = cast(list[Release], response.json())
